...
public class Grade_calculator {
        ...
        while (true) {
            if (numSubjects == 0) {
                ...
                for (int i = 0; i < numSubjects; i++) {
                    ...
                    scanner.nextLine(); // Consume the newline character
                    gradeMap.put(subject, grade); // Add the subject and grade to the map
                }
                System.out.println("**********************************");
                break;
            }
    ...
    public static int total_marks(Map<String, Integer> x) {
        ...
        return sum; // Return the sum of the grades
    }

    public static double calc_avg() {
        average = sum / numSubjects;
        return Math.round(average * 100.0) / 100.0; // Return the average of the grades
    }
    ...
    public static char grader() {
        if (average >= 80) {
            ...
            return 'F';
        } // Return the overall grade based on the average
    }
}
